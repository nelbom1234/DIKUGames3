...
namespace Galaga.GalagaStates {
    ...
    public class MainMenu : IGameState {
        ...
        public void InitializeGameState() {
            ...
            menuButtons.Add( new Text("NEW GAME", new Vec2F(0.47f, 0.4f),new Vec2F(0.2f, 0.2f)));
            menuButtons[0].SetColor(new Vec3F(1.0f,0.0f,0.0f));
            menuButtons.Add( new Text("QUIT", new Vec2F(0.5f, 0.3f), new Vec2F(0.2f, 0.2f)));
        ...
        /// for details).</param>
        public void HandleKeyEvent(string keyAction, string keyboardKey) {
